...
all_platforms = [
  ...
  DevicePlatform(cpid=0x8955, cprv=0x20, scep=0x10, arch='armv7s', srtg='iBoot-1145.3.3',
    ...
    DevicePlatform(cpid=0x8000, cprv=0x20, scep=0x01, arch='armv7k', srtg='iBoot-2234.0.0.3.3',
    rom_base=0x40000000, rom_size=0x100000, rom_sha1='645f0eda24c94e114324975dfb2f4ece75025cb8',
